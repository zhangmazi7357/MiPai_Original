...
public class MessageDialog {
    ...
    public static class Builder
        ...
        private void initialize() {
            ...
            tv_see_detail=findViewById(R.id.tv_see_detail);
        ...
        public Builder setDetail(String text, View.OnClickListener listener) {
            tv_see_detail.setText(text);
            tv_see_detail.setVisibility(View.VISIBLE);
            tv_see_detail.setOnClickListener(listener);
            return this;
        }
