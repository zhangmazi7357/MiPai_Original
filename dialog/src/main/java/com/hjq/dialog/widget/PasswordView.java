...
public class PasswordView extends View {
    ...
    private String text="668899";
    private int mTextPaintColor=0x172036;
    ...
    private void initialize(Context context) {
        ...
        textPaint.setColor( mPointColor);
    ...
    private void drawBlackPoint(Canvas canvas) {
        ...
        if (drawText&&!TextUtils.isEmpty(getText())) {
            for (int i = 0; i < mCurrentIndex; i++) {
                canvas.drawText(getText().toString().substring(i, i + 1), (i+1) * mItemWidth - mItemWidth / 2, mItemHeight/2, textPaint);
            }
        } else {
