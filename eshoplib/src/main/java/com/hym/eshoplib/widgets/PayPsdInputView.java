...
public class PayPsdInputView extends AppCompatEditText {
    ...
    private int focusedColor = Color.parseColor("#ccad69");
    ...
    private void initPaint() {
        ...
        textPaint.setTextSize(ScreenUtil.dip2px(getContext(), 18));
    ...
    private void drawPsdCircle(Canvas canvas) {
        if (drawText) {
            for (int i = 0; i < textLength; i++) {
                canvas.drawText(getText().toString().substring(i, i + 1), startX + i * 2 * startX, startY, textPaint);
            }
        } else {
            for (int i = 0; i < textLength; i++) {
                canvas.drawCircle
...
//            canvas.drawCircle(i * mItemWidth - mItemWidth / 2,
//                              mItemHeight / 2,
//                              mPointRadius,
//                              mPointPaint);
        }
