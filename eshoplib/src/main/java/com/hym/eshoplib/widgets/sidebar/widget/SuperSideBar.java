...
package com.hym.eshoplib.widgets.sidebar.widget;
...
import com.hym.eshoplib.widgets.sidebar.helper.IIndexBarDataHelper;
import com.hym.eshoplib.widgets.sidebar.helper.IndexBarDataHelperImpl;
...
public class SuperSideBar extends View {
     ...
     * sideBar的背景颜色
     */
    private int sideBarBg = R.color.transparent;
    /**
     * 按下的是显示的背景色
     */
    private int sideBarPressBg = R.color.transparent;
    /**
     * indexBar的字母颜色
     */
    private int sideBarTextColor = R.color.black;
    /**
     * indexBar选中的字母颜色
     */
    private int sideBarTextColorPress = R.color.mipaiTextColorSelect;
    /**
     * 该字母是否选中
     */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mIndexDatas.size(); i++) {
            int colorId = i == choose ? R.color.mipaiTextColorSelect
                    : sideBarTextColor;
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                setBackgroundColor(ContextCompat.getColor(getContext(),R.color.resource_gray_f1f1f1));
