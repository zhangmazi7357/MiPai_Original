...
public class UploadStudyCardFragment extends BaseKitFragment {
    ...
    public static UploadStudyCardFragment newInstance(Bundle args) {
        UploadStudyCardFragment fragment = new UploadStudyCardFragment();
    ...
    public void doLogic() {
            ...
            public void handleMessage(Message msg) {
                ...
                CommonApi.uploadFile(_mActivity, files, new ResponseImpl<UploadFilesBean>() {
                    ...
                    public void onSuccess(UploadFilesBean data) {
                        ...
                        switch (MsgWhat) {
                            case 1:
                                ImageUtil.getInstance().loadRoundCornerImage(UploadStudyCardFragment.this, url, ivCard1, 5);
                            ...
                            case 2:
                                ...
                                ImageUtil.getInstance().loadRoundCornerImage(UploadStudyCardFragment.this, url, ivCard2, 5);
                            ...
                            case 3:
                                ...
                                ImageUtil.getInstance().loadRoundCornerImage(UploadStudyCardFragment.this, url, ivCard3, 5);
        ...
        if (urls_1 != null && urls_1.size() > 0) {
            if (urls_1.size() == 1) {
                tvCard1.setVisibility(View.INVISIBLE);
                ImageUtil.getInstance().loadRoundCornerImage(UploadStudyCardFragment.this, urls_1.get(0).getFilepath(), ivCard1, 5);
                ivCard1.setVisibility(View.VISIBLE);
                ivDelet1.setVisibility(View.VISIBLE);
                ...
                tvCard2.setVisibility(View.INVISIBLE);
                ImageUtil.getInstance().loadRoundCornerImage(UploadStudyCardFragment.this, urls_1.get(1).getFilepath(), ivCard2, 5);
                ivCard2.setVisibility(View.VISIBLE);
                ivDelet2.setVisibility(View.VISIBLE);
                ...
                tvCard3.setVisibility(View.INVISIBLE);
                ImageUtil.getInstance().loadRoundCornerImage(UploadStudyCardFragment.this, urls_1.get(2).getFilepath(), ivCard3, 5);
                ivCard3.setVisibility(View.VISIBLE);
                ivDelet3.setVisibility(View.VISIBLE);
                url1 = urls_1.get(0).getId();
                url2 = urls_1.get(1).getId();
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.tv_card_1:
                MsgWhat = 1;
                PhotoUtil.ShowDialog(UploadStudyCardFragment.this, 1, false,2);
                break;
