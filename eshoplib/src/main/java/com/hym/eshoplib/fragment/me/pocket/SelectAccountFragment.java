            ...
            public void onClick(View v) {
                DialogUtil.getSelectDialog(_mActivity, "编辑", "删除", new DialogUtil.OnSelectDialogListener() {
                    ...
                    public void onBtnTwoClick(Dialog dialog) {
                        ...
                        Dialog pDialog = DialogUtil.getTowButtonDialog(_mActivity, "提示", "您确定要删这个账号么", cancle, confirm, new DialogUtil.OnDialogHandleListener() {
                            @Override
                            ...
                            public void onConfirmeClick(SweetAlertDialog sDialog) {
                                sDialog.dismiss();
                                MeApi.DelBank( getAdapter().getData().get(position).getUserbank_id(), new ResponseImpl<Object>() {
                                    @Override
