...
public class MzProVideoDetailAdapter extends BaseMultiItemQuickAdapter<UpLoadImageBean, BaseViewHolder> {
    ...
    public MzProVideoDetailAdapter(Fragment fragment, List<UpLoadImageBean> data) {
        super(data);
