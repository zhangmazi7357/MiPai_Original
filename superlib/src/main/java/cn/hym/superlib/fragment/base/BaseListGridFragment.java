...
public abstract class BaseListGridFragment<E> extends BaseKitFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
...
//        iv_add.setVisibility(View.VISIBLE);
    ...
    private void initRecyclerView() {
        rv_list.setLayoutManager(getGridLayoutManager());
    ...
    //获取布局管理器，默认线性
    public RecyclerView.LayoutManager getLineLayoutManager() {
